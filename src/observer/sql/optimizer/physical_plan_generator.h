...
public:
  ...
  RC create(LogicalOperator &logical_operator, std::shared_ptr<PhysicalOperator> &oper);
...
private:
  ...
  RC create_plan(InsertLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
  RC create_plan(DeleteLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
  RC create_plan(ExplainLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
  RC create_plan(JoinLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
  RC create_plan(CalcLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
  ...
  RC create_vec_plan(ExplainLogicalOperator &logical_oper, std::shared_ptr<PhysicalOperator> &oper);
};
