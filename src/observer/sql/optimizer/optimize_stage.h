...
private:
   ...
   */
  RC create_logical_plan(SQLStageEvent *sql_event, std::shared_ptr<LogicalOperator> &logical_operator);
   ...
   */
  RC rewrite(std::shared_ptr<LogicalOperator> &logical_operator);
   ...
   */
  RC optimize(std::shared_ptr<LogicalOperator> &logical_operator);
   ...
   */
  RC generate_physical_plan(std::shared_ptr<LogicalOperator> &logical_operator,
      std::shared_ptr<PhysicalOperator> &physical_operator, Session *session);
