...
FieldMeta::FieldMeta(const char *name, AttrType attr_type, int attr_offset, int attr_len,
...
RC FieldMeta::init(const char *name, AttrType attr_type, int attr_offset, int attr_len,
    bool visible, bool nullable)
{
